					...
					<div class="profile-head">
						...
						<div class="profile-info">
							<div class="profile-photo">
								<a class="test-popup-link" href="<?php echo base_url('public/assets/images/profile/egucation-girl.png'); ?>"><img src="<?php echo base_url('public/assets/images/profile/egucation-girl.png'); ?>" class="img-fluid rounded-circle" alt=""></a>
							</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="profile-blog">
									...
									<h4><a href="<?php echo site_url('post_details'); ?>" class="text-black">Darwin Creative Agency Theme</a></h4>
							...
							<div class="card-body">
								<div class="profile-interest">
									...
									<div class="row mt-4 sp4" id="lightgallery">
										...
										<a href="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" data-src="" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
								...
								<div class="profile-news">
									...
									<div class="media pt-3 pb-3">
										...
										<div class="media-body">
											<h5 class="m-b-5"><a href="<?php echo site_url('post_details'); ?>" class="text-black">Collection of textile samples</a></h5>
									...
									<div id="my-posts" class="tab-pane fade active show">
										<div class="my-post-content pt-3">
											...
											<div class="profile-uoloaded-post border-bottom-1 pb-5">
												...
												<a class="post-title" href="<?php echo site_url('post_details'); ?>"><h3 class="text-black">Collection of textile samples lay spread</h3></a>
