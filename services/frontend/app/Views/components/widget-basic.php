...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="row">
                                ...
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media me-2">
                                            <img alt="image" width="50" src="<?php echo base_url('public/assets/images/avatar/1.jpg'); ?>">
                                        </div>
                        ...
                        <div id="DZ_W_Todo3" class="widget-media dlab-scroll height370">
                            <ul class="timeline">
                                ...
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media me-2 media-success">
                                            <img alt="image" width="50" src="<?php echo base_url('public/assets/images/avatar/2.jpg'); ?>">
                                        </div>
                                        <div class="media-body">
                                ...
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media me-2 media-primary">
                                            <img alt="image" width="50" src="<?php echo base_url('public/assets/images/avatar/3.jpg'); ?>">
                                        </div>
                                        <div class="media-body">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div class="profile-photo">
                                <img src="<?php echo base_url('public/assets/images/profile/profile.png'); ?>" width="100" class="img-fluid rounded-circle" alt="">
                            </div>
            ...
            <div class="col-xl-4 col-lg-12 col-sm-12">
                <div class="card overflow-hidden">
                    <div class="text-center p-3 overlay-box " style="background-image: url(<?php echo base_url('public/assets/images/big/img1.jpg'); ?>);">
                        <div class="profile-photo">
                            <img src="<?php echo base_url('public/assets/images/profile/profile.png'); ?>" width="100" class="img-fluid rounded-circle" alt="">
                        </div>
            ...
            <div class="col-xl-4 col-lg-12 col-sm-12">
                <div class="card overflow-hidden">
                    <div class="text-center p-5 overlay-box" style="background-image: url(<?php echo base_url('public/assets/images/big/img5.jpg'); ?>);">
                        <img src="<?php echo base_url('public/assets/images/profile/profile.png'); ?>" width="100" class="img-fluid rounded-circle" alt="">
                        ...
                        <div class="widget-media">
                            <ul class="timeline">
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media me-2">
                                            <img alt="image" width="50" src="<?php echo base_url('public/assets/images/avatar/4.jpg'); ?>">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mb-1">Dr sultads Send you Photo</h5>
                                            <small class="d-block">29 July 2020 - 02:26 PM</small>
