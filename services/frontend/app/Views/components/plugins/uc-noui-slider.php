            ...
            <div class="col-xl-4">
                <div class="card">
					...
					<div class="card-body">
                        <div class="slider-disabled ">
                            <div id="disable2"></div>
                            <div class="form-check custom-checkbox checkbox-primary mb-2 me-3">
								<input type="checkbox" class="form-check-input" id="checkbox2" required="">
								<label class="form-check-label mb-0" for="checkbox2">Disable handle 1</label>
							</div>
							<div class="form-check custom-checkbox checkbox-primary mb-2 me-3">
								<input type="checkbox" class="form-check-input" id="checkbox3" required="">
								<label class="form-check-label mb-0" for="checkbox3">Disable handle 2</label>
							</div>
                        </div>
                    </div>
                </div>
