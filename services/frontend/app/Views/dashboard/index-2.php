						...
						<div class="card dlab-join-card h-auto">
							<div class="card-body">
								<div class="dlab-media d-flex justify-content-between">
									...
									<div class="dlab-img">
										<img src="<?php echo base_url('public/assets/images/egucation-girl.png'); ?>" alt="">
									</div>	
									<div class="dlab-icon">
										<img src="<?php echo base_url('public/assets/images/vector/calpng.png'); ?>" alt="" class="cal-img">
										<img src="<?php echo base_url('public/assets/images/vector/book.png'); ?>" alt="" class="book-img">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-xl-4 col-sm-6">
								<div class="dlab-cource bg-secondary">
									...
									<img src="<?php echo base_url('public/assets/images/vector/check.png'); ?>" alt="">
								</div>
							</div>
							<div class="col-xl-4 col-sm-6">
								<div class="dlab-cource">
									...
									<img src="<?php echo base_url('public/assets/images/vector/bookmarks.png'); ?>" class="bookmarks" alt="">
								</div>
							</div>
							<div class="col-xl-4 col-sm-12">
								<div class="dlab-cource bg-primary">
									...
									<img src="<?php echo base_url('public/assets/images/vector/bulb.png'); ?>" class="bulb" alt="">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body pt-3">
								...
								<div class="redial-content">
									...
									<a href="<?php echo site_url('course_details_2'); ?>" class="btn btn-primary">More Details</a>
								</div>
							</div>
						</div>
					</div>
