					...
					<div class="dlab-side-menu">	
						...
						<ul>
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="<?php echo base_url('public/assets/images/profile/pic1.jpg'); ?>" width="20" alt=""/>
								</a>
								<div class="dropdown-menu dropdown-menu-end">
									<a href="<?php echo site_url('app_profile'); ?>" class="dropdown-item ai-icon">
									...
									<a href="<?php echo site_url('email_inbox'); ?>" class="dropdown-item ai-icon">
									...
									<a href="<?php echo site_url('page_login'); ?>" class="dropdown-item ai-icon">
